...
FileNodeHeader = "FileNodeHeader" / Struct(
    ...
    / Enum(Int32ul, one=0x0000002A, onetoc2=0x0000001B),
    ...
    / Enum(Int32ul, one=0x0000002A, onetoc2=0x0000001B),
    "fcrLegacyFreeChunkList" / Struct("stp" / Int32ul, "cb" / Int32ul),
    "fcrLegacyTransactionLog" / Struct("stp" / Int32ul, "cb" / Int32ul),
    "cTransactionsInLog" / Int32ul,
    "cbLegacyExpectedFileLength" / Int32ul,
    "rgbPlaceholder" / Int64ul,
    "fcrLegacyFileNodeListRoot" / Struct("stp" / Int32ul, "cb" / Int32ul),
    ...
    "crcName" / Int32ul,
    "fcrHashedChunkList" / Struct("stp" / Int64ul, "cb" / Int32ul),
    "fcrTransactionLog" / Struct("stp" / Int64ul, "cb" / Int32ul),
    "fcrFileNodeListRoot" / Struct("stp" / Int64ul, "cb" / Int32ul),
    "fcrFreeChunkList" / Struct("stp" / Int64ul, "cb" / Int32ul),
    ...
    "fcrDebugLog" / Struct("stp" / Int64ul, "cb" / Int32ul),
...
FileNodeListFragment = "FileNodeListFragment" / Struct(
    "FileNodeListHeader"
    / Struct(
        "uintMagic" / Int64ul, "FileNodeListID" / Int32ul, "nFragmentSequence" / Int32ul
    ),
    "FileNode"
    / BitStruct(
