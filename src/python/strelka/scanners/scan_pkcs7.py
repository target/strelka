        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(dir=tmp_directory) as tmp_data:
                ...
                try:
                    ...
                    self.flags(f"{self.__class__.__name__} Exception:  Error loading PKCS7 key file with SMIME error.")
                    return
                ...
                try:
                    ...
                    self.flags(f"{self.__class__.__name__} Exception:  Error collecting PKCS7 signers.")
                    return
                ...
                if certs:
                    ...
                    for cert in certs:
                        try:
                            ...
                            self.flags(f"{self.__class__.__name__} Exception:  Error processing PKCS7 signers.")
                            return
                        self.event["total"]["extracted"] += 1
        except tempfile.NamedTemporaryFile:
            self.flags(f"{self.__class__.__name__} Exception: Error creating temporary file for PKCS7 file.")
        except Exception as e:
