...
1. Get pre-reqs and libs:
    ```sh
    yum install curl gcc git libtool make python36-setuptools python36-devel python-wheel upx jq libarchive-devel libffi-devel ssdeep-libs ssdeep-devel tesseract file-devel perl-Image-ExifTool openssl-devel python-pip3 protobuf protobuf-devel autoconf automake unzip gcc-c++
    ```
